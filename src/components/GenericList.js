...
export default function GenericList(props) {
    ...
    return (
        ...
        <div className="container top-0 flex-col items-center px-10 py-16 mx-auto md:h-screen md:py-32 md:flex-row text-black">
            ...
            {listItems.map((listItem) => (
                ...
                <div className="flex flex-row items-center h-full p-4 bg-gray-200 rounded">
